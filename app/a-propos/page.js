  ...
  return (
    <div>
      ...
      <p className="mt-5 text-justify">
        ...
        son professionnalisme et sa disponibilité, ce qui lui a permis de gagner
        rapidement la confiance de ses clients. Grâce à un engagement constant
        envers la qualité de service et une approche personnalisée, CannelleChx
        a su se faire un nom dans le secteur du nettoyage et de l'entretien de
      ...
      <p className="mt-5 text-justify">
        ...
        dans la gestion locative de chalets et d'appartements haut de gamme.
        Aujourd'hui, Flores & Cie continue d'exceller dans l'entretien et la
      ...
      <p className="mt-5 text-justify">
        ...
        et une réactivité optimales. Nous sommes fiers de notre métier, et cela
        se reflète dans nos tenues sobres et élégantes. Nous attachons une
